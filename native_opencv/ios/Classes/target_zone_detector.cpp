...
//            }
//        }
//        platform_log("Final ring diameters (after 25px filtering):");
//
////        for (size_t i = 0; i < filtered_ellipses.size(); i++) {
////
////            float avg_diameter = (filtered_ellipses[i].size.width + filtered_ellipses[i].size.height) / 2.0f;
////
////            std::cout << "Ring " << i << " (largest to smallest): "
////                      << "width=" << filtered_ellipses[i].size.width
////                      << " height=" << filtered_ellipses[i].size.height
////                      << " avg_diameter=" << avg_diameter << std::endl;
////        }
//
//        for (size_t i = 0; i < filtered_ellipses.size(); i++) {
//            float w = filtered_ellipses[i].size.width;
//            float h = filtered_ellipses[i].size.height;
//            float avg = (w + h) / 2.0f;
//            platform_log(
//                    "Ring %zu (largest to smallest): width=%.2f height=%.2f avg_diameter=%.2f",
//                    i, w, h, avg
//            );
//        }
//
...
//        std::cout << "Frame validation failed: " << validation_message << std::endl;
        platform_log("Frame validation failed: %s", validation_message.c_str());

//        platform_log("Frame validation failed: %s", validation_message);
