          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 4),
                Text('See past sessions and results.', style: AppTheme.labelMedium(context)),
                SizedBox(height: AppTheme.spacingLarge),
      ...
      listener: (context, state) {
        if (state is SyncCompleted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text(state.message), backgroundColor: AppTheme.success(context)),
          );
          ...
          children: [
            Expanded(
              child: ElevatedButton.icon(
                onPressed: isLoading ? null : () {
                  context.read<ArmoryBloc>().add(SyncLocalToRemoteEvent(userId: userId));
                },
                icon: Icon(Icons.cloud_upload_outlined, size: AppTheme.iconSmall),
            ...
            Expanded(
              child: OutlinedButton.icon(
                ...
                icon: Icon(Icons.cloud_download_outlined, size: AppTheme.iconSmall),
