...
class BleList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<TrainingBloc, TrainingState>(
      builder: (context, state) {
        return _BleListContent(state: state);
      },
    );
  }
}
...
class _BleListContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final connectedDevices = bluetoothDevices
        .where((d) => state.connectedBleId == d.id)
        .toList();
    final availableDevices = bluetoothDevices
        .where((d) => state.connectedBleId != d.id)
        .toList();
