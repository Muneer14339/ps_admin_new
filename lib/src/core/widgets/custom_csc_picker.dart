...
const Map<CscCountry, int> Countries = {
  ...
  CscCountry.Afghanistan: 232,
  CscCountry.Aland_Islands: 233,
...
class CSCPickerCustom extends StatefulWidget {
  ///CSC Picker Constructor
  const CSCPickerCustom(
      {super.key,
  ...
  @override
  CSCPickerCustomState createState() => CSCPickerCustomState();
}

class CSCPickerCustomState extends State<CSCPickerCustom> {
  ...
  Widget countryDropdown() {
    return DropdownWithSearchCustom(
...
class DropdownWithSearchCustom<T> extends StatelessWidget {
  final String title;
  ...
  const DropdownWithSearchCustom(
      {super.key,
      required this.title,
  ...
  Widget build(BuildContext context) {
    return AbsorbPointer(
      ...
      child: GestureDetector(
        ...
        child: Container(
          padding: isSignUpScreen == null
              ? const EdgeInsets.symmetric(horizontal: 8, vertical: 14)
              : EdgeInsets.fromLTRB(13.w, 16.h, 13.w, 16.h),
          decoration: !disabled
              ? decoration ??
                  BoxDecoration(
          ...
          child: isSignUpScreen == null
              ...
              : Row(
                  children: [
                    Image.asset('assets/icons/location.png', height: 22.h),
                    SizedBox(width: 12.w),
                    Expanded(
                        child: Text(selected.toString(),
                            overflow: TextOverflow.ellipsis,
...
class CustomDialog extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final DialogThemeData dialogTheme = DialogTheme.of(context); // ✅ Use DialogThemeData
        ...
        child: Center(
          child: ConstrainedBox(
            ...
            child: Material(
              ...
              shape: shape ?? dialogTheme.shape ?? _defaultDialogShape, // ✅ No need for casting
              child: child,
            ),
          ),
        ),
