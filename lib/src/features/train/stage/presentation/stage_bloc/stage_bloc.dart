...
class StageBloc extends Bloc<StageEvent, StageState> {
  StageBloc() : super(StageInitial()) {
    ...
    on<FireArmDropDownChangedEventGen>((event, emit) {
      ...
      //   list = allFireArms.where((e) {

      //     bool matches = true;
      //     if (firearm.brandIsCustom != true) {
      //       matches = matches && e.brand == firearm.brand;
      //     }
      //     if (firearm.modelIsCustom != true) {
      //       matches = matches && e.model == model;
      //     }
      //     if (firearm.generationIsCustom != true) {
      //       matches = matches && e.generation == generation;
      //     }
      //     if (firearm.caliberIsCustom != true) {
      //       matches = matches && e.caliber == caliber;
      //     }
      //     if (firearm.type != null) {
      //       matches = matches && e.type == firearm.type;
      //     }
      //     return matches;
      //   }).toList();
      //   list = list.fold<List<FirearmEntity>>([], (prev, element) {
      ...
      if (firearm.generation != null) {
        ...
        //       .where((e) =>
        //           (e.type == firearm.type) &&
        //           (e.generation == firearm.generation))
        //       .toList();
        //   //------------------------------------------
        // } else if (firearm.brandIsCustom == true &&
        //     firearm.generationIsCustom == true) {
        //   caliberList = allFireArms
        //       .where(
        //           (e) => (e.type == firearm.type) && (e.model == firearm.model))
        //       .toList();
        //   //------------------------------------------
        // } else if (firearm.generationIsCustom == true &&
        //     firearm.modelIsCustom == true) {
        //   caliberList = allFireArms
        //       .where(
        //           (e) => (e.brand == firearm.brand) && (e.type == firearm.type))
      ...
      if (firearm.caliber != null) {
        ...
        //           (e.caliber == caliber))
        //       .toList();
        // } else if (firearm.caliberIsCustom == true) {
        //   firingMacList = allFireArms
        //       .where((e) =>
        //           (e.brand == firearm.brand) &&
        //           (e.type == firearm.type) &&
