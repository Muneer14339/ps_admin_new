...
abstract class ArmoryLocalDataSource {
  ...
  Future<ArmoryLoadoutModel?> getLoadoutById(String userId, String loadoutId);
  Future<ArmoryFirearmModel?> getFirearmById(String userId, String firearmId);
  Future<ArmoryAmmunitionModel?> getAmmunitionById(String userId, String ammunitionId);
}