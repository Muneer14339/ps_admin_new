...
class CommunityFormsView extends StatelessWidget {
  const CommunityFormsView({super.key});
  ...
  Widget build(BuildContext context) {
    return CustomPaint(
      ...
      child: Scaffold(
        appBar: appBarCustom(ctx: context, title: 'Community & Forums'),
        body: ListView(
          padding: hPadding,
          children: [
            const Gap(35),
